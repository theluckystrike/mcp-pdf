...
test.skip("free tier: six files are refused with the upgrade line, Pro merges them", async () => {
...
test.skip("an existing out_path is refused and the file on disk is not touched", async () => {
...
test.skip("the business footer prints the shared profile, and says so when there is none", async () => {
