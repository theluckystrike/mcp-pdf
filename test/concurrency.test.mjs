...
test.skip("two processes, one data dir: 20 concurrent operations all reach the register", async () => {
...
test.skip("two processes racing one out_path: exactly one wins and the other writes nothing", async () => {
...
test.skip("a failed split leaves none of its reserved outputs behind", async () => {
...
test.skip("a corrupt register blocks the register, not the file that was written", async () => {
